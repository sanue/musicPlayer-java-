...
<head>
    ...
    margin: 20px;
    line-height: 200px;
    background: rgba(249, 244, 244, 0.26);
        font-size: 15px;
        cursor:pointer;
}
	</style>
...
<body>
<div style="background-color:black;height: 100%;margin-left: -25px;margin-right: -25px;">
	<div class="homebox">
		<a href="javascript:show('modify')"><div class="tip">修改密码</div></a>
		<a href="javascript:show('section');"><div class="tip">歌曲分类模块</div></a>
		<a href="javascript:show('classify');"><div class="tip">歌手分类管理</div></a>
		<a href="singerInfo.html"><div class="tip">歌手信息管理</div></a>
		<a href="songInfo.html"><div class="tip">歌曲内容管理模块</div></a>
		<a href="javascript:show('members');"><div class="tip">会员管理</div></a>
	</div>
	<div class="stars">
